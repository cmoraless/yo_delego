...
public interface OnRegisterFragmentListener {
    ...
    void createAccount(boolean student, String name, String rut, String lastName, String email, String password, String university, String career, String semester);
    void finish();
    void goToWall();
    void goToLogin();
}