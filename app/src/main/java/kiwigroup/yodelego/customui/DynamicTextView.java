...
/**
 * Created by cristian on 4/13/17.
 */
...
public class DynamicTextView extends android.support.v7.widget.AppCompatTextView {
    ...
    private void setCustomFont(Context ctx, AttributeSet attrs) {
        ...
        for(int i = 0 ; i < attrs.getAttributeCount() ; i++) {
            if(attrs.getAttributeName(i).equalsIgnoreCase("weight")) {
                weight = attrs.getAttributeValue(i);
            }
        }
        this.setTypeface(Typeface.createFromAsset(ctx.getAssets(),"fonts/OpenSans-" + weight + ".ttf"));
    }
